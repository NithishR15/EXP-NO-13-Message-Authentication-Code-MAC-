...
int main() {
    ...
    printf(" NAME : NITHISH R\n");
    printf(" REG NO : 212223040135\n\n");
...
## OUTPUT :
![Screenshot 2024-10-21 123150](https://github.com/user-attachments/assets/82ac91d2-c774-4e0d-82f0-be2a5431bf8f)
